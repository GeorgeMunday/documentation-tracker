  ...
  return (
    <div>
      ...
      <ContentField>
        ...
        <EmailSubmit />
        <WelcomeMessage title="Verify Your Email" message="You will receive a confirmation email shortly." />
        <WelcomeMessage title="Unsubscribe" message="If you wish to unsubscribe, please click the link below." />
        <WelcomeMessage title="Send Now" message="Click the button below to send your email immediately." />
      </ContentField>
      </div>
    </div>
  )
